...
const items: { text: string, type: 'tech' | 'project' | 'interest' }[] = [
  ...
  { text: "Flutter", type: "tech" },
  { text: "Dart", type: "tech" },
  { text: "Firebase", type: "tech" },
  { text: "Java", type: "tech" },
  { text: "SQL", type: "tech" },
  { text: "Git", type: "tech" },
  
  // Projects - List your key projects or work experience
  { text: "SaladBar", type: "project" },
  { text: "Fushati", type: "project" },
  { text: "EBS API", type: "project" },
  { text: "SMS/EMAIL Microservices", type: "project" },
  
  // Interests/Background - Share your interests and background
  { text: "Cybersecurity", type: "interest" },
  { text: "Full Stack Development", type: "interest" },
  { text: "Computer Science", type: "interest" },
  { text: "DevOps", type: "interest" },
  { text: "Linux", type: "interest" },
]
